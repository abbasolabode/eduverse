	...
	return (
		<>
			<div className="w-full sm:w-[40rem] min-h-screen flex flex-col md:w-[48rem] bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
				...
				{/* Header */}
				<div className="min-w-full md:min-w-[48rem] md:min-h-[8.5rem] md:pl-[1.5rem] md:pr-[1.5rem] mt-[6.5rem] flex items-center bg-indigo-100">
					<div className="min-w-full md:min-w-full min-h-full flex items-center justify-between gap-4">
						{/* Student dashboard header */}
						<div className="flex items-center md:min-w-[15.9675rem] md:min-h-[6.5rem] gap-1">
							<div className="flex items-center sm:min-w-[]">
								<FaGraduationCap className="min-w-[1.95375rem] min-h-[2rem] text-indigo-400" />
							</div>
							<div className="md:min-w-[13.26375rem] flex flex-col gap-1">
						...
						<div className="flex items-center gap-2">
							{/* Avatar & Initials */}
							<div className="md:min-w-[10.375rem] md:min-h-[3.5rem] min-w-full flex items-center gap-1">
							...
							{/* Back home button */}
							<div className="min-w-full md:min-w-[7.55766875rem] md:ml-[1rem]">
								<BackHomeButton studentDashboardStyle="shadow-sm bg-white border-indigo-300  hover:shadow-lg transition-all duration-300 hover:ring-2 hover:ring-indigo-400 animation-all ">
				...
				<div className="min-w-full md:min-w-[48rem] md:min-h-[2.5rem] md:pl-[1.5rem] md:pr-[1.5rem] md:pt-[2rem] md:pb-[2rem]">
					{/* Mapped Links */}
					<div className="flex gap-1 items-center justify-between md:min-w-[28rem] md:min-h-[2.5rem] min-w-full md:pl-[0.25rem] md:pr-[0.25rem] md:pt-[0.25rem] md:pb-[0.25rem] bg-indigo-50 rounded-sm">
						{studentDashboardLinks.map((link) => (
							<div
								key={link?.id}
								className="min-w-full md:min-w-[8.125rem] md:min-h-[2rem]"
							>
								<Link
									to={link?.link}
									className={`flex text-white gap-2 items-center justify-center bg-gradient-to-r from-blue-300 to-purple-600 ${
