...
export default function WhyChoosePathways() {
  return (
    <main className="max-w-full  sm:max-w-[40rem] md:max-w-full md:min-h-[26.125rem] sm:py-20 min-h-[49.125rem] gap-5 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 flex flex-col items-center">
      {/* Header section */}
      <div className="sm:max-w-[37rem] max-w-full md:max-w-[45rem] md:min-h-[6.75rem] text-center px-4 pb-16">
      ...
      {/* Centered Cards */}
      <div className="w-full max-w-[37rem] md:max-w-full  space-y-4 flex flex-col md:flex-row gap-4 ">
        {whyPathways.map((item) => (
          <div key={item.id} className="min-h-[10.825rem] md md:max-w-[13.66625rem] rounded-lg shadow-lg hover:shadow-xl bg-white mx-4">
