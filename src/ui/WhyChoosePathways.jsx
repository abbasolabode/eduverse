...
export default function WhyChoosePathways() {
  return (
    <main className=" min-w-full  sm:max-w-[40rem] md:max-w-full md:min-h-[26.125rem] sm:py-20 min-h-[49.125rem] gap-5 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 flex flex-col items-center lg:min-w-[64rem] ">
      {/* Header section */}
      <div className="min-w-full sm:max-w-[37rem] max-w-full md:max-w-[45rem] md:min-h-[6.75rem] text-center px-4 pb-16 lg:min-w-[60rem] lg:min-h-[7rem]  lg:flex lg:flex-col lg:items-center">
      ...
      {/* Centered Cards */}
      <div className="min-w-full max-w-[37rem] md:max-w-full  space-y-4 flex flex-col md:flex-row gap-4  lg:min-w-[60rem] lg:flex lg:justify-center">
