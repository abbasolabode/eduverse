...
export default function AcademicPrograms() {
	...
	return (
		<div className="w-full min-h-screen flex flex-col lg:items-center lg:min-w-[64rem] overflow-hidden ">
			...
			<main className="w-full sm:w-[37rem] flex-1 sm:min-h-[30.75rem] mx-auto mt-6 md:w-[48rem] md:pt-[4rem] md:pb-[4rem] md:pl-[1.5rem] lg:grid md:pr-[1.5rem] md:grid md:grid-cols-2 lg:gap-10 lg:min-w-[64rem] lg:grid-cols-3 lg:items-center lg:pl-[2rem] lg:pr-[2rem] pt-[4rem] lg:pb-[4rem] ">
