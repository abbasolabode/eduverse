...
export default function ReadyToBeginJourney({
	...
	return (
		<div
			className={`sm:max-w-[40rem] sm:min-h-[15.25rem] mt-[4rem] md:max-w-full flex flex-col items-center overflow-hidden max-auto bg-gradient-to-r from-blue-600 to-purple-700 ${academicProgramStyleForReadyToBegin} lg:min-w-[64rem] lg:min-h-[10.5rem] `}
		>
			<div className="sm:w-[37rem] sm:min-h-[8.5rem] md:max-w-[48rem] flex flex-col gap-2 sm:pt-10 lg:min-w-[50rem]">
				<h2 className="text-[2.25rem] font-semibold md:max-w-[45rem] md:min-h-[2.25rem] font-poppins text-center text-white">
					Ready to Begin Your Journey
				</h2>
				<p className="sm:w-full min-h-[3.5rem] md:min-w-[43rem] md:min-h-[3.5rem] md:pl-[1rem] md:pr-[1rem] text-[1.25rem] text-center font-lato text-white lg:min-w-[53rem] lg:min-h-[1.75rem]  ">
