	...
	return (
		<div>
			...
			<div className="min-w-full min-h-full ">
				<div className="md:min-h-[2.5rem] md:min-w-[48rem] flex justify-end items-center sm:w-[38rem]">
					<button
						onClick={() => navigate("/studentDashboard/biodataForm")}
						className="flex gap-2 justify-center items-center md:min-w-[8.8rem] md:min-h-[2.5rem] text-white bg-[#111827] rounded-md md:mr-4 font-lato font-medium sm:min-h-[2.5rem] sm:w-[8.8025rem]"
					>
						<span>
							<FiEdit />
						</span>
			...
			<div className="min-w-full md:min-w-[44.875rem] md:min-h-[10rem] md:pl-[1.5rem] md:pr-[1.5rem] md:pb-[1.5rem] mt-8 flex flex-col items-center mx-auto gap-5  sm:w-[37.875rem] sm:pl-[1.5rem] sm:pt-[1.5rem] sm:pb-[1.5rem] sm:pr-[1.5rem] sm:items-center">
				{/* Personal Information */}
				<div className="w-full md:w-full rounded-md pl-5 pr-5 pt-4 pb-4 shadow-md bg-white sm:w-[37.875rem] ">
					<div className="md:min-w-[41.87rem] md:min-h-[4.75rem]">
						<h3 className="font-semibold font-lato">Personal Information</h3>
					</div>
					<div className="md:min-h-[11.75rem] md:max-w-[41.87rem] flex flex-col gap-2 ">
						<span className="flex items-center justify-between w-full md:max-w-[41.87rem] text-[0.875rem]">
							<p className="min-h-[1.25rem] text-[#4B5563] font-lato ">
								Full Name:
							</p>
							<p className="font-semibold font-lato text-[0.875rem]">
								{authUser?.fullName}
							</p>
						</span>
						<span className="flex items-center justify-between w-full md:max-w-[41.87rem] text-[0.875rem]">
							<p className="min-h-[1.25rem] text-[#4B5563] font-lato text-[0.875rem]">
								Student ID:
							</p>
							<p className="font-semibold font-lato text-[0.875rem]">
								{authUser?.studentId}
						...
						<span className="flex items-center justify-between min-w-full md:max-w-[41.87rem] text-[0.875rem]">
							<p className="min-h-[1.25rem] text-[#4B5563] font-lato text-[0.875rem]">
								Date of Birth:
							</p>
							<p className="font-semibold font-lato text-[0.875rem]">
				...
				<div className="w-full md:w-full  rounded-md pl-5 pr-5 pt-4 pb-4 shadow-md bg-white">
					<div className="md:max-w-[41.87rem] md:min-h-[4.75rem]">
						<h3 className="font-semibold font-lato">Academic Information</h3>
					</div>
					<div className="md:min-h-[11.75rem] md:max-w-[41.87rem] flex flex-col gap-2">
						<span className="flex items-center justify-between max-w-full md:max-w-[41.87rem] text-[0.875rem]">
							<p className="min-h-[1.25rem] text-[#4B5563] font-lato ">
								Program:
							</p>
							<p className="font-semibold font-lato"> {authUser?.program}</p>
						</span>
						<span className="flex items-center justify-between max-w-full md:max-w-[41.87rem] tracking-wider text-[0.875rem]">
							<p className="min-h-[1.25rem] text-[#4B5563] font-lato ">
								Level:
							</p>
				...
				<div className="w-full md:w-full rounded-md pl-5 pr-5 pt-4 pb-4 shadow-md bg-white">
					...
					<div className="md:min-h-[11.75rem] md:max-w-[41.87rem] flex flex-col gap-2 ">
						...
						<span className="flex items-center justify-between min-w-full md:max-w-[41.87rem] tracking-wider text-[0.875rem]">
							<p className="min-h-[1.25rem] text-[#4B5563] font-lato ">
								Current Address:
							</p>
							<p className="font-semibold font-lato text-[0.875rem]">
